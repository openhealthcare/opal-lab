...
class LabTest(omodels.PatientSubrecord):
    ...
    def update_from_dict(self, data, user, **kwargs):
        ...
        for observation in self.all_observations._observation_types:
        ...
        for observation in observation_data:
            if "id" in observation:
                ...
                to_save = getattr(self.all_observations, observation["name"])
    ...
    def to_dict(self, *args, **kwargs):
        ...
        for observation_type in self.all_observations._observation_types:
